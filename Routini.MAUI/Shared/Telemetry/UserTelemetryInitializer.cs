...
namespace Routini.MAUI.Shared.Telemetry
{
    ...
    {
        private const string USER_ID_PREFERENCE_KEY = "user_id";
        ...
        {
            string? userId = Preferences.Get(USER_ID_PREFERENCE_KEY, null);
            ...
            Preferences.Set(USER_ID_PREFERENCE_KEY, newUserId);
